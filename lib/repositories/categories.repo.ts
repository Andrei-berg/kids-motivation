// lib/repositories/categories.repo.ts
// Supabase queries for categories and tasks (family-scoped).
// Sourced from lib/categories-api.ts — this is the authoritative implementation.

import { createClient } from '@/lib/supabase/client'
import type { Category, Task } from '../models/category.types'
