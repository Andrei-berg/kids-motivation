...
export default function ParentNav() {
  ...
  const NAV_LINKS = NAV_LINK_DEFS.map((link) => ({ ...link, label: t(link.labelKey) }))
  ...
  return (
    <>
      {/* Desktop top bar */}
      <nav className="hidden md:flex items-center gap-1 px-6 py-3 bg-gray-900 border-b border-gray-700">
        <span className="text-indigo-400 font-bold text-sm mr-6 tracking-wide uppercase">
          {t('nav.parentCenter')}
        </span>
        {NAV_LINKS.map((link) => {
