...
| 003 | weekly-boost | How should the weekly boost show *why* it's filling, not just that it is? | All 3 kept as a selectable per-child boost-detail style (opened by tapping the inline meter) | boost, progress |
